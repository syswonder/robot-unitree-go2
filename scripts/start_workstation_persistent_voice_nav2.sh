...
INHERITED_ROBOTTRACK_DISTANCE_MODE="${GO2_ROBOTTRACK_DISTANCE_MODE:-}"
INHERITED_ROBOTTRACK_LEAN_MODE="${GO2_ROBOTTRACK_LEAN_MODE:-}"
INHERITED_ROBOTTRACK_TARGET_DISTANCE_M="${ROBOTTRACK_TARGET_DISTANCE_M:-}"
INHERITED_ROBOTTRACK_SERVER_URL="${ROBOTTRACK_SERVER_URL:-}"
INHERITED_ROBOTTRACK_INSTRUCTION="${ROBOTTRACK_INSTRUCTION:-}"
if [[ -f "$ROOT/.env" ]]; then
  set -a
...
export GO2_ROBOTTRACK_DISTANCE_MODE="$INHERITED_ROBOTTRACK_DISTANCE_MODE"
export GO2_ROBOTTRACK_LEAN_MODE="$INHERITED_ROBOTTRACK_LEAN_MODE"
export ROBOTTRACK_TARGET_DISTANCE_M="$INHERITED_ROBOTTRACK_TARGET_DISTANCE_M"
